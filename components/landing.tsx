...
export default function Landing({ onSignIn }: LandingProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary via-secondary to-accent">
      ...
      {/* Hero Section */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-6 py-20 md:px-12 md:py-32 max-w-7xl mx-auto">
        {/* Left Column */}
        <div className="space-y-8">
          ...
          <Button onClick={onSignIn} size="lg" variant="secondary" className="w-full md:w-fit">
            Get Started
          </Button>
        </div>
