...
export default function HRDirectorPage() {
  ...
  // Accept HR director roles
  const allowedRoles: UserRole[] = ['HR_DIRECTOR', 'hr_director'] as UserRole[]

  // Redirect if not authenticated or not HR director
  ...
  return (
    <Suspense fallback={<AuthLoadingSkeleton />}>
      <PortalWrapper 
        ...
        userRole={user?.role || 'HR_DIRECTOR'} 
      />
    </Suspense>
  )
}
