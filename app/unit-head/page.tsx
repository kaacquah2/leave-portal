...
export default function UnitHeadPage() {
  ...
  // Accept unit head roles
  const allowedRoles: UserRole[] = ['UNIT_HEAD', 'unit_head'] as UserRole[]

  // Redirect if not authenticated or not unit head
