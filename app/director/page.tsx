...
export default function DirectorPage() {
  ...
  // Accept director roles
  const allowedRoles: UserRole[] = ['DIRECTOR', 'director', 'directorate_head', 'deputy_director'] as UserRole[]

  // Redirect if not authenticated or not director
