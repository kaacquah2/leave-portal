  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.welcomeText}>HR Dashboard</Text>
      ...
      <View style={styles.actionsContainer}>
        <TouchableOpacity
          ...
          onPress={() => router.push('/(tabs)/staff-management')}
        >
          <Text style={styles.actionButtonText}>👥 Manage Staff</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.actionButton}
          onPress={() => router.push('/(tabs)/leave-management')}
        >
          <Text style={styles.actionButtonText}>📅 Leave Management</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.actionButton}
